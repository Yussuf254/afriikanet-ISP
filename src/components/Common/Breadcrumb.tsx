...
const Breadcrumb: React.FC<BreadcrumbProps> = ({
  ...
  return (
    <div className="dark:bg-darkmode relative z-10 overflow-hidden pb-10 pt-20 md:pt-24 lg:pt-28">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            <div className="text-center">
              <h1 className="text-black mb-4 text-2xl sm:text-3xl md:text-4xl font-bold dark:text-white">
                {pageName}
              </h1>
