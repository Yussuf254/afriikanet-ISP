...
const HeroSub: FC<HeroSubProps> = ({ title, subtitle, breadcrumb }) => {
    ...
    return (
        <>
            <section className="py-16 md:py-20 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 mt-16 md:mt-20 relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-600/20 rounded-full blur-3xl"></div>
                
                <div className="container mx-auto lg:max-w-screen-xl px-4 relative z-10 pt-4">
                    {breadcrumb && (
