...
export default function Page() {
    return (
        <div className="bg-slate-50 min-h-screen">
            {/* Hero Section */}
            <section className="bg-gradient-to-r from-slate-800 to-slate-900 py-16 pt-28">
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 text-center">
                    <h1 className="text-4xl font-bold text-white mb-4">Documentation</h1>
                    <p className="text-xl text-amber-400">Everything you need to know about Afriikanet ISP Billing System</p>
                </div>
            </section>

            {/* Content Sections */}
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 py-12">
                <Introduction />
                <PackageVersions />
                <PackageStructure />
                <QuickStart />
